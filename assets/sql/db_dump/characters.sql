...
CREATE TABLE `character_stats` (
  ...
  `spell_damage` int(10) unsigned NOT NULL DEFAULT '0',
  `spell_healing` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`guid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `characters` (
  ...
  `character_flags` int(10) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `migrations` VALUES ('20220813085336'),('20221001202815'),('20241002031703'),('20241113131610'),('20241114131912'),('20250428111913'),('20250712023524');
